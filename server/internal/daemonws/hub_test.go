...
func TestHeartbeatRoundTrip(t *testing.T) {
	...
	hub.SetHeartbeatHandler(func(_ context.Context, identity ClientIdentity, runtimeID string, _ bool, _ json.RawMessage) (*protocol.DaemonHeartbeatAckPayload, error) {
		calls.Add(1)
...
func TestHeartbeatHandlerCtxNotTimeBounded(t *testing.T) {
	...
	hub.SetHeartbeatHandler(func(ctx context.Context, _ ClientIdentity, runtimeID string, _ bool, _ json.RawMessage) (*protocol.DaemonHeartbeatAckPayload, error) {
		select {
...
func TestHeartbeatRejectsUnauthorizedRuntime(t *testing.T) {
	...
	hub.SetHeartbeatHandler(func(context.Context, ClientIdentity, string, bool, json.RawMessage) (*protocol.DaemonHeartbeatAckPayload, error) {
		called.Store(true)
