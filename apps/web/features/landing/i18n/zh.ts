...
export function createZhDict(allowSignup: boolean): LandingDict {
  ...
  hero: {
    ...
    headlineLine2: "不是人類。",
    subheading:
      "Multica 是一個開源平臺，將編碼 智慧體 變成真正的隊友。分配任務、跟蹤進度、積累技能——在一個地方管理你的人類 + 智慧體 團隊。",
    cta: "免費開始",
    downloadDesktop: "下載桌面端",
    talkToSales: "聯絡商務",
    worksWith: "支援",
    imageAlt: "Multica 看板檢視——人類和 智慧體 協同管理任務",
  },

  features: {
    teammates: {
      label: "團隊協作",
      title: "像分配給同事一樣分配給 智慧體",
      description:
        "智慧體 不是被動工具——它們是主動參與者。它們擁有個人資料、報告狀態、建立任務、發表評論、更新狀態。你的活動流展示人類和 智慧體 並肩工作。",
      cards: [
        {
          title: "智慧體 出現在指派人選擇器中",
          description:
            "人類和 智慧體 出現在同一個下拉選單裡。把任務分配給 智慧體 和分配給同事沒有任何區別。",
        },
        {
          title: "自主參與",
          description:
            "智慧體 主動建立任務、發表評論、更新狀態——而不是隻在被提示時才行動。",
        },
        {
          title: "統一的活動時間線",
          description:
            "整個團隊共用一個活動流。人類和 智慧體 的操作交替展示，你始終知道發生了什麼、是誰做的。",
        },
      ],
    },
    autonomous: {
      label: "自主執行",
      title: "設定後無需管理——智慧體 在你睡覺時工作",
      description:
        "不只是提示-響應。完整的 task 生命週期管理：入隊、領取、啟動、完成或失敗。智慧體 主動報告阻塞，你透過 WebSocket 獲取實時進度。",
      cards: [
        {
          title: "完整的任務生命週期",
          description:
        ...
        },
        {
          title: "主動報告阻塞",
          description:
            "當 智慧體 遇到困難時，會立即發出警報。不用等幾個小時後才發現什麼都沒發生。",
        },
        {
          title: "實時進度推送",
          description:
            "基於 WebSocket 的實時更新。實時觀看 智慧體 工作，或隨時檢視——時間線始終是最新的。",
        },
      ],
    },
    skills: {
      ...
      description:
        "技能是可複用的能力定義——程式碼、配置和上下文打包在一起。只需編寫一次，團隊中每個 智慧體 都能使用。你的技能庫隨時間不斷積累。",
      cards: [
        {
          title: "可複用的技能定義",
          description:
            "將知識封裝成任何 智慧體 都能執行的技能。部署到測試環境、編寫遷移、審查 PR——全部程式碼化。",
        },
        {
          title: "全團隊共享",
          description:
            "一個人的技能就是每個 智慧體 的技能。編寫一次，全團隊受益。",
        },
        {
          title: "複合增長",
          description:
            "第 1 天：你教 智慧體 部署。第 30 天：每個 智慧體 都能部署、寫測試、做程式碼審查。團隊能力指數級增長。",
        },
      ],
    },
    runtimes: {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        title: "指派一個任務並觀察它工作",
        description:
          "從指派人下拉選單中選擇你的 智慧體——就像指派給同事一樣。task 自動入隊、領取、執行。實時觀看進度。",
      },
    ],
    cta: "開始使用",
  ...
  openSource: {
    ...
    headlineLine2: "為所有人。",
    description:
      "Multica 完全開源。審查每一行程式碼，按你的方式自託管，塑造人類 + 智慧體 協作的未來。",
    cta: "在 GitHub 上 Star",
    highlights: [
      {
        title: "隨處自託管",
      ...
      },
      {
        title: "無供應商鎖定",
        description:
          "自帶 LLM 提供商、更換 智慧體 後端、擴充套件 API。你擁有整個技術棧的控制權。",
      },
      {
        title: "預設透明",
        description:
          "每一行程式碼都可審計。確切瞭解你的 智慧體 如何做決策、任務如何路由、資料流向何方。",
      },
      {
        title: "社群驅動",
        description:
          "與社群一起建設，而不僅僅是為社群建設。貢獻技能、整合和 智慧體 後端，讓每個人受益。",
      },
    ],
  },
    ...
    items: [
      ...
      },
      {
        question:
          "這和直接用編碼 智慧體 有什麼區別？",
        answer:
          "編碼 智慧體 擅長執行。Multica 新增的是管理層：任務佇列、團隊協作、技能複用、執行時監控，以及每個 智慧體 在做什麼的統一檢視。把它想象成你的 智慧體 的專案經理。",
      },
      {
        question: "智慧體 能自主處理長時間任務嗎？",
        answer:
          "可以。Multica 管理完整的任務生命週期——入隊、領取、執行、完成或失敗。智慧體 主動報告阻塞並實時推送進度。你可以隨時檢視，也可以讓它們執行整晚。",
      },
      {
        question: "我的程式碼安全嗎？智慧體 在哪裡執行？",
        answer:
          "智慧體 在你的機器（本地守護程序）或你自己的雲基礎設施上執行。程式碼永遠不會經過 Multica 伺服器。平臺只協調任務狀態和廣播事件。",
      },
      {
        question: "我可以執行多少個 智慧體？",
        answer:
          "取決於你的硬體。每個 智慧體 有可配置的併發限制，你可以連線多臺機器作為執行時。開源版本沒有任何人為限制。",
      },
    ],
  },
  ...
  footer: {
    tagline:
      "人類 + 智慧體 團隊的專案管理。開源、可自託管、為未來的工作方式而建。",
    cta: "開始使用",
    groups: {
      product: {
        label: "產品",
  ...
  changelog: {
    ...
    entries: [
      ...
      },
      {
        version: "0.4.40",
        date: "2026-09-04",
        title: "MCP 伺服器改名與連線替換、升級期間任務啟動更穩、登入過期的乾淨退出、共享智慧體狀態更準",
        changes: [],
        features: [
          "給 MCP 伺服器改名不會再弄丟連線配置和已分配的智慧體。",
          "要換成新的連線配置，現在是一個單獨、明確的操作。",
          "儲存 MCP 伺服器時會直接定位到需要修改的那一項。",
        ],
        improvements: [
          "智慧體的每一次執行，在各端和文件裡統一叫「執行」。",
          "搜尋結果返回更快了。",
        ],
        fixes: [
      ...
      },
      {
        ...
        features: [
          ...
          "數字和日期屬性還可以按區間篩選。",
          "命令列可以檢視還在執行的智慧體任務，父 Issue 和子 Issue 一起看。",
      ...
      },
      {
        ...
        features: [
          ...
          "Oh My Pi 智慧體現在可以在智慧體頁面配置並使用 MCP。",
        ],
        improvements: [
          "執行時只會在確實安全時被回收，不會在執行中途被收走。",
          "長時間離線的執行時，現在只會如實說明當前狀態。",
          "智慧體的長步驟最多可以空閒兩小時，不會被提前中斷。",
      ...
      },
      {
        version: "0.4.35",
        date: "2026-08-26",
        title: "全渠道 /new 與 /clear、智慧體開場建議、收件箱篩選",
        changes: [],
        features: [
          "用 /new 開新會話，用 /clear 清空當前會話。",
          "釘釘、飛書、Slack、Telegram、企業微信都已支援。",
          "可以給智慧體設定最多 3 條開場建議，空白聊天裡會直接顯示。",
      ...
      },
      {
        ...
        fixes: [
          ...
          "評論時間不再顯示成錯誤的時區。",
          "智慧體用完整 ID 定位 Issue 更快、更穩定。",
          "取消任務後，智慧體程序會真正停止，不再在後臺殘留。",
          "已取消訂閱的席位不再出現在賬單裡。",
          "任務被取消時，命令列不再誤提示重新登入。",
        ],
      },
      ...
      },
      {
        version: "0.4.30",
        date: "2026-08-19",
        title: "更安全的 Issue 編輯、未設定屬性篩選、清晰的智慧體身份",
        changes: [],
        features: [
          "現在可以看到每個聊天會話由哪個智慧體處理。",
      ...
      },
      {
        version: "0.4.29",
        date: "2026-08-18",
        title: "MiniMax Code、執行記錄最佳化、Hermes 智慧體行為修復",
        changes: [],
        features: [
          "現在可以用 MiniMax Code 執行智慧體。",
          "按 Cmd/Ctrl+, 就能在桌面端新標籤頁開啟設定。",
        ],
        improvements: [
          "Hermes 智慧體呼叫工具時，執行記錄會立即顯示。",
          "執行記錄去掉了重複的智慧體名稱，更容易瀏覽。",
        ],
        fixes: [
          "短暫斷線後，智慧體任務會繼續執行。",
          "日度和周度費用圖現在計入快取讀取費用。",
          "在飛書裡直接發的檔案和音訊現在會傳給智慧體。",
          "委派任務失敗後，會回到原來的協調智慧體。",
          "下載頁面現在只會顯示最新的完整版本。",
        ],
      },
      ...
      },
      {
        ...
        changes: [],
        features: [
          "現在可以把智慧體接入 Telegram，在私聊、群組或論壇話題中與它對話。",
          "本地目錄可以選並行模式，多個任務同時跑，各自交一個分支。",
          "一個釘釘機器人可以給不同群指定不同的智慧體。",
          "匯入的技能可以一鍵更新到最新版，智慧體繫結照舊保留。",
          "滑鼠停在 Issue 提及上，就能看到標題、負責人和子任務進度。",
          "jcode 的智慧體現在可以選思考強度了。",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "智慧體在企業微信裡做好的檔案，會直接發到對話裡。",
          "網頁、飛書、企業微信、釘釘對話裡，智慧體不再忘掉之前聊過的。",
          "智慧體的環境變數可以整段貼上，也能一次批次編輯。",
          "手機和平板上也能對列表逐條做歸檔、置頂、重新命名了。",
          "新建工作區時，Issue 字首可以自己填，不再一律是 WS。",
        ],
        improvements: [
          "模型列表裡能分清 Codex gpt-5.6 的幾個版本了。",
          "設定和智慧體頁裡的每個聊天頻道都用上了自己的標記。",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "發給企業微信機器人的圖片、檔案和影片，智慧體現在都能看到。",
          "Reasonix 的智慧體現在可以選思考強度了。",
        ...
        improvements: [
          ...
          "一次取消很多工比以前更快了。",
          "釘釘設定頁用上了釘釘自己的標記。",
          "智慧體回覆你的評論時，不會再把別人也拉進來。",
        ],
        fixes: [
          "Hermes 智慧體的記憶能跨任務保留下來了。",
      ...
      },
      {
        ...
        features: [
          ...
          "Oh-My-Pi 現在也能跑你的智慧體了。",
          "企業微信裡的語音留言，智慧體現在也聽得懂。",
          "Kimi 和 Pi 的智慧體現在可以選思考強度了。",
        ...
        fixes: [
          ...
          "Windows 上的 OpenClaw 智慧體現在能讀到你的配置。",
          "連著發好幾條訊息時，不會再有一條被漏掉。",
      ...
      },
      {
        ...
        fixes: [
          ...
          "Windows 上的 Pi 智慧體能穩定啟動，不再卡在提示詞上。",
      ...
      },
      {
        version: "0.4.18",
        date: "2026-08-04",
        title: "智慧體指令更精簡，大量問題修復",
        changes: [],
        features: [
          "指派確認彈窗支援用傳送快捷鍵確認，不必再切到滑鼠。",
          "建立智慧體時的對話會保留下來，之後可以隨時回看。",
        ],
        improvements: [
          "建立智慧體的頁面開著時，不再拖慢整個工作區。",
          "建立智慧體時填寫的內容會自動儲存，切換頁面後依然保留。",
          "Skill 的檔案行選單裡可以直接進入編輯。",
          "聊天中的快捷建議會跟隨你正在使用的語言。",
          "智慧體每次執行讀取的說明更精簡，佔用的上下文更少。",
          "本地構建的執行時會明確標註，不再提示並不存在的更新。",
          "執行時詳情頁的標題不再重複顯示機器名。",
        ],
        fixes: [
          "中斷回覆後繼續傳送訊息，智慧體仍然記得之前的對話。",
          "建立智慧體的輸入框在傳送後清空，緊接著輸入的內容也不會丟失。",
      ...
      },
      {
        ...
        fixes: [
          ...
          "自帶 Codex 指令檔案的智慧體現在能正常開始 task。",
          "給原本沒有觸發器的 Autopilot 選好定時，現在能儲存下來了。",
          "開啟智慧體匯入的 Skill，不再顯示你沒做過的改動。",
      ...
      },
      {
        version: "0.4.16",
        date: "2026-07-31",
        title: "一鍵下一步、連結變卡片，智慧體更穩",
        changes: [],
        features: [
          "聊天回覆下方會給出後續建議，點一下就直接發出。",
          "把常用的智慧體和提示詞存成快捷操作，在任意任務側欄一鍵觸發。",
          "貼上任務或專案連結，會直接顯示成卡片，不再是一長串網址。",
          "在收件箱裡右鍵通知即可標回未讀，留著稍後再看。",
          "可以給智慧體設定 emoji 頭像，也能一眼看出它用的是哪個執行時。",
          "建立智慧體時，執行時裡多了 Qoder CN 可選。",
        ],
        improvements: [
          "刪除大型自託管工作區現在快很多，不用一直乾等。",
          "所有工作區都能給智慧體和 Skill 打標籤，方便歸類和查詢。",
        ...
        fixes: [
          ...
          "智慧體拆出子任務時，訂閱的人現在會收到通知。",
          "自託管改用自定義埠後，啟動和連線不再對不上。",
          "用量排行榜裡單個智慧體的數字，不再超過同期總量。",
          "工作中的智慧體數量，現在只算篩選出的任務，不再算整個工作區。",
          "超大的訊息不再影響實時連線的穩定。",
          "自託管升級到新版本不再中途失敗。",
      ...
      },
      {
        ...
        improvements: [
          ...
          "介面與四語文件現在更清晰、更一致。",
          "包含大量附件的命令列和智慧體 task 現在傳輸更少資料。",
          "自託管配置現在會正確應用到守護程序。",
        ],
        fixes: [
          "Codex 對檔案的改動現在會完整保留在 task 記錄中。",
          "Hermes 恢復會話失敗時，智慧體現在會自動恢復。",
      ...
      },
      {
        version: "0.4.14",
        date: "2026-07-29",
        title: "智慧體更快，檔案更安全，任務表格更順暢",
        changes: [],
        features: [
          "執行中安裝的智慧體 CLI 現在會自動出現。",
          "智慧體所有者現在可以管理自己的環境變數。",
        ],
        improvements: [
          "切換執行時後，可用模型現在顯示得更快。",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "用量頁現在會顯示錯誤趨勢、失敗型別和相關智慧體。",
          "現在可以直接從 GitHub App 匯入多個倉庫。",
          "建立智慧體時，現在可以設定思考強度和 Codex 加速。",
          "父任務現在會顯示子任務中有多少智慧體正在工作。",
        ],
        improvements: [
        ...
        fixes: [
          ...
          "Slack 和 Lark 現在只接收最終回答，Qoder 智慧體也不例外。",
        ],
      },
      {
        version: "0.4.12",
        ...
        fixes: [
          ...
          "快速重複同一個操作不再報錯了。",
          "切回任務列表時，內容現在會保持最新。",
          "Codex 智慧體現在能可靠地恢復會話了。",
          "桌面端裡的圖片等媒體現在能正常顯示了。",
          "取消 task 現在會徹底停止智慧體。",
          "上一個會話無法恢復時，智慧體 task 現在能自動恢復了。",
        ],
      },
      {
        version: "0.4.11",
        ...
        changes: [],
        features: [
          "現在可以基於 Claude Opus 5 搭建智慧體了。",
        ],
        improvements: [
          "智慧體啟動的長時間執行服務，現在在 task 結束後仍會繼續執行。",
          "非程式碼類工作區不再夾帶智慧體用不上的軟體工程說明了。",
        ],
      },
      {
        version: "0.4.10",
        ...
        features: [
          ...
          "任務表格現在會直接顯示哪些智慧體正在處理。",
          "複製的記錄現在會帶上每條事件的時間戳。",
        ],
        improvements: [
          "Cursor 智慧體現在會實時顯示它的思考和工具呼叫。",
          "現在可以基於最新的 Kimi Code 模型搭建智慧體了。",
          "執行時別名現在在全站各處都能一致顯示了。",
          "專案裡的 GitHub 連結現在會清晰顯示 owner/repo。",
          "當你機器上的智慧體服務過舊、無法使用專案上下文時，Chat 現在會提醒你。",
          "滾動載入更多工時會顯示“載入中”，到底部會提示“沒有更多了”。",
        ],
        fixes: [
          "在看板和列表裡滾動載入更多工時，不再閃現整頁骨架屏了。",
          "恢復的 Grok 會話不再顯示為 $0，計費與 xAI 實際收取一致。",
          "建立智慧體出錯時，錯誤資訊現在會一直顯示，方便你排查。",
          "在 Lark 群聊裡，回覆現在會使用正確話題的上下文。",
          "Hermes 智慧體不再誤報供應商錯誤了。",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "現在可以用更快的 Codex 極速模式執行智慧體了。",
          "子任務現在能直接顯示優先順序、標籤、進度和截止日期。",
          "你可以自選每個子任務要顯示哪些資訊。",
          "Inbox 現在會在列表裡直接顯示哪些智慧體正在處理。",
        ],
        improvements: [
      ...
      },
      {
        ...
        fixes: [
          ...
          "開啟任務時，子任務列表現在會保持最新。",
          "Grok 智慧體現在能準確上報 token 用量了。",
          "Qwen 智慧體現在可以在 task 中執行命令、修改檔案了。",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "你現在可以基於 Qwen Code 執行時搭建智慧體了。",
          "智慧體在聊天裡畫的圖表，現在會真正顯示為圖表了。",
        ],
        improvements: [
          "指派確認彈窗現在秒開，不再有載入等待。",
        ],
      ...
      },
      {
        version: "0.4.5",
        date: "2026-07-20",
        title: "可自定義的任務表格、實時排序的看板，以及更穩的智慧體 task",
        changes: [],
        features: [
        ...
        improvements: [
          ...
          "智慧體 task 不再在準備階段卡住，會盡快開始或乾脆快速失敗。",
          "Codex 智慧體現在能拿到你為它設定的自定義環境金鑰。",
        ],
        fixes: [
          "恢復的 Codex 和 Hermes 聊天不再返回空白回覆。",
          "桌面端現在會以你上次關閉時的大小和位置重新開啟。",
          "切換智慧體的執行時現在會正確重置它的模型和思考級別。",
          ...
          "AI 輔助建立現在始終可用。",
          "任務頁面首次開啟時不再卡頓。",
          "Linux 上的 Codex 智慧體現在能正確儲存 Git 資訊。",
      ...
      },
      {
        ...
        improvements: [
          "智慧體的長 task 遇到短暫斷網不再失敗，會自動重試繼續跑完。",
          "現在可以在設定裡選擇建立任務時顯示哪些欄位。",
          "任務列表頁現在能清楚看到當前有多少智慧體在工作。",
        ...
        fixes: [
          "切換聊天會話時現在總會停在最新的訊息。",
          "智慧體不再在結果裡留下你打不開的本地檔案連結。",
          "桌面端遇到失效連結時會顯示正常的提示頁，而不是崩潰介面。",
          "收件箱裡已歸檔的條目不再顯示為未讀。",
          "把內容貼上進有序列表時序號會保持正確。",
          "某些按鍵情況下鍵盤快捷鍵不再誤觸發。",
          "自託管升級不再中途卡住。",
          "Codex 智慧體 task 現在能用正確的憑證執行。",
          "Cursor 智慧體在終端出錯時更穩定了。",
          "更新自動化時不再丟失它繫結的智慧體。",
        ],
      },
      {
        version: "0.4.3",
        date: "2026-07-16",
        title: "獨立的任務視窗、收件箱歸檔，以及更穩的智慧體 task",
        changes: [],
        features: [
        ...
        improvements: [
          "重試失敗的智慧體 task 時，會保留它已經做過的工作，不再從頭再來。",
        ...
        fixes: [
          "新建對話時切換智慧體，不會再把你已經輸入的內容弄丟。",
          "自動化執行中，智慧體又可以透過 @ 互相交接 task 了。",
          "自動化執行現在會使用最新的專案設定。",
          "長時間的智慧體 task 不會再悄無聲息地結束，或沒跑完就被標記完成。",
          "使用新的 Codex gpt-5.6 Sol 模型時，已完成的 task 不會再被誤判為失敗。",
          "Codex 智慧體不會再因為啟動慢或在 Linux 上寫檔案而失敗。",
      ...
      },
      {
        version: "0.4.2",
        date: "2026-07-15",
        title: "自定義任務欄位、成員歸屬與 Grok 智慧體",
        changes: [],
        features: [
          "你現在可以給任務自定義欄位了，並直接在列表裡看到。",
          "現在能看到每個智慧體的執行背後是哪位成員在負責。",
          "你現在可以基於 Grok 搭建智慧體了。",
          "智慧體列表現在會顯示訪問範圍，還能篩選和批次修改。",
        ...
        fixes: [
          "CodeBuddy 智慧體現在能用上分配給它的技能和記憶。",
          "opencode 智慧體的 task 在意外結束時不再一直掛著。",
          "更多型別的金鑰現在會自動從日誌裡隱藏。",
      ...
      },
      {
        version: "0.4.1",
        date: "2026-07-14",
        title: "DevEco Code 智慧體、桌面自動更新與穩定性提升",
        changes: [],
        features: [
          "你現在可以基於 DevEco Code 搭建智慧體了。",
        ...
        fixes: [
          "Hermes 智慧體現在能用上分配給它的技能，寫檔案也不會再被攔下。",
      ...
      },
      {
        version: "0.4.0",
        date: "2026-07-13",
        title: "自定義快捷鍵、對話式建立智慧體，介面煥新",
        changes: [],
        features: [
          "你現在可以自定義常用操作的快捷鍵，桌面端還能錄製瀏覽器平時佔用的組合鍵。",
          "透過對話一步步說清需求，就能建立一個新智慧體。",
          "配置智慧體的技能、工具、執行時和訪問許可權，現在更清晰、更省事。",
          "智慧體詳情頁新增私信按鈕，可以直接找它對話。",
          "智慧體現在能在聊天回覆裡傳送圖片和檔案。",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "你現在可以讓智慧體執行在全新的 Codex gpt-5.6 模型上——Sol、Terra 和 Luna。",
          "輸入或貼上像 MUL-123 這樣的任務編號，它會自動變成可點選的任務連結。",
          "上傳頭像時，你現在可以先裁剪、縮放和旋轉，再儲存。",
          "當智慧體最終沒有文字回覆時，聊天裡會顯示清晰的“無回覆”提示，而不是一條空訊息。",
          "在多個不同的評論會話裡提到同一個繁忙的智慧體，現在每個會話都會各自得到回覆。",
        ],
        improvements: [
          "智慧體、小隊和工作區的頭像現在處處都是圓形，與成員頭像保持一致。",
          "一次性修改多個子任務的狀態時，現在會直接生效，不再多出一步讓人困惑的確認。",
          "智慧體還在回覆時你發出的聊天訊息，現在一定會被下一次回覆接住，不會丟失。",
          "你機器上的本機後臺會自動把自己的日誌控制得很小，不會再撐滿磁碟。",
        ],
        fixes: [
          "即使你電腦的時鐘和伺服器略有偏差，連線 Lark 機器人現在也能成功。",
          "Cursor 智慧體現在能重新正確連上它所配置的工具。",
          "恢復時卡住的 Claude 智慧體會話，現在能自動恢復並繼續執行。",
        ],
      },
      {
        version: "0.3.42",
        ...
        features: [
          ...
          "把滑鼠懸停在智慧體上，就能看到它正在使用哪個模型以及思考強度，無需開啟詳情頁。",
        ],
        improvements: [
        ...
        fixes: [
          "你在任務上的追加評論不會再丟失，即使在智慧體處理時發出也一定會被接收。",
          "當一個智慧體提到另一個智慧體時，被提到的那個現在會可靠地開始工作。",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "你現在可以給機器起名字，建立智慧體時的執行時選擇器支援搜尋並按機器分組。",
          "任何成員現在都能自己建立和管理小隊，不再只有管理員可以。",
          "智慧體的擁有者現在可以直接連線和管理它的飛書機器人，不需要管理員許可權。",
          "你現在可以在命令列裡給任務排序，並指定精確位置。",
        ],
        improvements: [
          "對話裡智慧體 task 失敗時，現在會給出友好、易懂的提示，並提醒你重試。",
        ],
        fixes: [
      ...
      },
      {
        ...
        improvements: [
          ...
          "更多智慧體供應商現在都能配置 MCP 了。",
          "開啟工作區時不再自動彈出對話視窗，你可以自己用懸浮按鈕開啟。",
        ],
        fixes: [
          "同一臺機器上並行執行的多個智慧體 task 不再互相干擾。",
          "斷開後把飛書機器人重新連回同一個智慧體時，成員的賬號繫結和會話不再丟失。",
      ...
      },
      {
        ...
        fixes: [
          "多階段小隊流程在私有 Leader + 子任務由智慧體關閉的情況下，不再卡在第一階段。",
          "父任務的「子任務完成」提示不再把中間階段錯說成最終階段，小隊 Leader 可以自己選擇繼續下一階段還是收尾。",
          "小隊 Leader 在收尾階段不再佔用本地倉庫的鎖，同一個倉庫裡的多個智慧體可以繼續並行工作。",
          "多小時的智慧體 task（研究、訓練、程式碼生成）不再被服務端誤殺，只要本機後臺還活著就會跑完。",
          "自託管環境下的搜尋不再卡死，大工作區裡首次搜尋也能秒回。",
          "在任務或評論編輯器裡貼上長報錯堆疊或異常長的字串時不再卡頁面。",
          "同時裝了 Claude 的機器上，Antigravity 智慧體不再啟動失敗。",
          "Windows 上的 Browser MCP 現在能正常啟動。",
          "Codex 智慧體的 MCP 設定能被正確讀取了。",
          "Pi 智慧體的 task 結果只顯示最終答案，不再夾帶中間步驟。",
      ...
      },
      {
        ...
        fixes: [
          ...
          "登入 Shell 裡掛了 hook 包裝時，守護程序也能正確發現智慧體 CLI（Claude、Codex 等）。",
          "新提交推送後，PR 審查智慧體會重新觸發審查，不再複用舊提交的結論。",
          ...
          "Codex 智慧體 task 能在 task 主目錄裡看到守護程序的 Codex 模型目錄。（社群反饋）",
          "`/squads/…` 與 `/usage` 老路徑不再 404，會重定向到當前對應頁面。",
          "桌面端「儲存」對話方塊展示真實的附件檔名，不再預設成 `download.txt`。（社群貢獻）",
          "小隊協作：Leader 透過 mention 派發的工作者智慧體，在透過 HTTP API 釋出完成評論時，能正確喚醒私有小隊 Leader；Leader → Worker → Leader 協作鏈不再在第一跳後卡住。",
      ...
      },
      {
        version: "0.3.35",
        date: "2026-07-02",
        title: "「顯示子任務」開關、任務檢視更快、智慧體 CLI 更安全",
        changes: [],
        features: [
          "任務檢視新增「顯示子任務」開關，看板、列表、泳道、甘特圖一鍵聚焦父任務。",
          "手動新建任務彈窗新增標籤選擇器，截止日期收進 ⋯ 摺疊選單。",
          "技能詳情頁支援一次把技能掛給多個智慧體，選擇器帶智慧體搜尋。",
          "自託管：S3 相容物件儲存支援 path-style 定址。",
        ],
        improvements: [
          "看板、列表、泳道、甘特圖共用一套查詢與快取：成員／智慧體 Tab 計數精確，跨專案移動按列表對賬，慢網下新增共用重新整理指示器。",
          "對話實時時間線不再在每條流式 task 訊息到來時重新掛載，長時間智慧體執行不再卡渲染。",
        ],
        fixes: [
          "同一小隊裡子任務完成時，父任務所屬小隊的 Leader 會被叫醒，父任務不再滯留處理中。",
          "受守護程序託管的智慧體 CLI 丟失 task token 時立刻失敗，寫操作不再冒充成工作區擁有者。（社群反饋）",
          "Slack 告警卡片（Grafana、Webhook 等）正文只在 Attachments / Blocks / rich_text 裡時，也能被聊天智慧體在歷史閱讀裡讀回。",
      ...
      },
      {
        version: "0.3.34",
        date: "2026-07-01",
        title: "Slack /issue 斜槓命令、位元組跳動 TRAE CLI 智慧體執行時、接入 Claude Sonnet 5",
        changes: [],
        features: [
          ...
          "位元組跳動 TRAE CLI（traecli）透過標準 ACP 協議接入為內建智慧體執行時之一。",
        ...
        fixes: [
          "Slack 聊天智慧體不再逐句解說自己在讀歷史，改為靜默閱讀、直接給出正式回覆。",
      ...
      },
      {
        ...
        features: [
          ...
          "Slack 頻道可以把過往對話回灌到 Multica，智慧體一進入頻道即擁有完整上下文。",
          "Slack 智慧體處理訊息期間會在使用者訊息上加 👀 反應表情，處理結束後穩定清除，不再出現卡死。",
          "技能包支援從本地 .skill / .zip 歸檔匯入。",
          "multica issue 命令不再接受短 UUID 字首，請使用任務 Key（MUL-123）或完整 UUID。",
          "Agents 頁面適配移動端。",
        ],
        improvements: [
          "重寫了評論路由級聯：父鏈 @ 提及、智慧體署名回覆、小隊 Leader 兜底，三條路徑匯入同一條經過充分測試的流程。",
        ...
        fixes: [
          ...
          "Antigravity 智慧體「完成回合但未輸出任何內容」時，回覆會被從執行記錄中補回，對話不再空白。",
          "在拒絕 CLIENT SETNAME 的託管 Redis 上，服務端啟動不再失敗。（社群貢獻）",
          "智慧體活動懸浮卡片頭部計數改為「N 個 task 正在執行」，與工作區顯示保持一致。",
        ],
      },
      {
        version: "0.3.32",
        ...
        improvements: [
          ...
          "守護程序在探測各個智慧體執行時版本時加上了獨立超時，單個卡死的 CLI 不會再連累其他執行時。",
        ],
        fixes: [
      ...
      },
      {
        ...
        fixes: [
          ...
          "把任務直接交給某個智慧體時，執行確認彈窗會立刻展開 Handoff 備註。",
      ...
      },
      {
        ...
        improvements: [
          ...
          "為每個服務商預設的智慧體啟動引數補齊說明文件，並下線了一次性的飛書切換開關——統一協作通道已經在生產環境完全接管",
        ],
        fixes: [
          ...
          "命令列智慧體會等待守護程序就緒後再決定鑑權來源，避免悄悄回落到個人訪問令牌；自託管環境配置流程也會沿用現有設定並清晰展示服務地址的變化",
          "飛書訊息中的網頁連結現在會指向你配置的應用 URL，而不是回退到通用網址",
          "Codex task 在輸出過載時也能正常清理，不會再卡住；Kiro task 即便關閉過程中出現錯誤，也能保留目標完成狀態；智慧體退出時會先終止整組 opencode 子程序，再關閉輸出",
      ...
      },
      {
        ...
        fixes: [
          ...
          "自動化冷啟動、任務頂部智慧體狀態和 Antigravity 服務商錯誤提示更準確",
        ],
      },
      {
        version: "0.3.28",
        ...
        features: [
          ...
          "現在指派或批次更新任務時，會先確認這次操作是否會啟動智慧體、啟動的是哪一個，讓你可以只改動而不觸發執行；確認啟動時，還能附上一段交接說明，作為智慧體這次執行的開場上下文",
          "Qoder 現在可以作為智慧體服務商使用，並帶有模型發現和服務商品牌展示",
          "自定義執行時可以配置固定啟動引數；儲存的執行時無法註冊時，也會給出更清楚的提示",
        ],
        improvements: [
          "專案描述現在會跟隨智慧體工作一起提供，讓智慧體獲得更穩定的專案上下文",
          "命令列現在支援處理評論解決狀態、檢視任務用量彙總，以及管理自動任務訂閱人",
          "只讀程式碼塊新增複製按鈕，官網頁頭的 GitHub 按鈕也會顯示實時星標數",
          "新版守護程序獲取智慧體技能時更高效，同時繼續相容舊版本守護程序",
        ],
        fixes: [
      ...
      },
      {
        ...
        improvements: [
          "任務頂部的智慧體活動狀態現在懸停即可展開，更方便快速檢視當前進展",
          "桌面側邊欄和固定導航更順滑、更清爽，減少不必要的視覺干擾",
          "聊天回覆、任務分配補讀和貢獻者指引更剋制，智慧體工作更容易留在正確位置",
      ...
      },
      {
        version: "0.3.25",
        date: "2026-06-18",
        title: "讓技能、自動任務和聊天中的智慧體工作更可靠",
        changes: [],
        features: [
          "開發者機器上的本地技能庫現在可以被自動識別，智慧體執行時更容易複用團隊能力",
          "自動任務可以配置預設訂閱人，新建任務時更容易把相關隊友帶入確認",
          "聊天附件會繫結到當前工作空間，傳送訊息時也不會阻塞後續對話",
          "智慧體評論傳送失敗後，可以直接在任務時間線裡重試",
        ],
        improvements: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "團隊可以建立自定義執行時，讓智慧體按環境使用合適的本地工具和模型",
          "命令列建立和更新智慧體時可以選擇思考強度",
        ],
        improvements: [
      ...
      },
      {
        ...
        fixes: [
          "回覆和編輯評論前，現在會更準確地預覽哪些智慧體或小隊會開始執行",
          "評論裡的普通任務編號會保持為普通文字，只有明確插入連結時才會變成連結",
          "透過命令列登入並選擇 Google 登入時，瀏覽器認證完成後現在會正確回到命令列",
          "聊天上傳檔案會等到當前智慧體準備好後再開放，避免載入過程中上傳失敗",
          "觸屏裝置上不需要懸停也能看到執行記錄裡的操作按鈕",
          "智慧體釋出評論的指令更穩，不容易因為命令格式問題漏掉指派人、專案或其他欄位",
        ],
      },
      {
        version: "0.3.22",
        ...
        changes: [],
        features: [
          "智慧體、自動任務、專案、執行環境、技能和小隊的列表體驗更快也更一致，行內容、篩選、選擇和操作都更清楚",
          "命令列現在可以管理工作區倉庫，本地智慧體更容易拿到專案倉庫上下文",
          "Cursor 和 OpenClaw 更容易配置：Cursor 連線設定可以由 Multica 託管，OpenClaw 也可以連線已有閘道器",
          "編輯評論時，可以在儲存前預覽並控制哪些智慧體或小隊會開始執行",
        ],
        improvements: [
          "桌面端恢復提示會帶上更多頁面上下文，反饋卡住視窗時更容易說清發生位置",
          "長任務和收件箱檢視在離開後返回時，會更穩定地保留滾動位置和評論錨點",
          "Cursor 的 Composer、快取輸入和新版 Cursor 智慧體輸出會展示更清楚的用量和計費資訊",
        ],
        fixes: [
          ...
          "智慧體 task 遇到無效執行憑證時，會安全停止而不是繼續執行",
        ],
      },
      {
        version: "0.3.21",
        ...
        changes: [],
        features: [
          "CodeBuddy 現在可以驅動本地 Multica 智慧體，並會自動顯示可用的模型和投入強度選項",
        ...
        fixes: [
          ...
          "本地智慧體執行不會再在 task 資料夾準備好之前就顯示已經開始",
        ],
      },
      {
        version: "0.3.20",
        date: "2026-06-11",
        title: "技能匯入、執行記錄和更穩定的智慧體",
        changes: [],
        features: [
        ...
        fixes: [
          "任務討論裡的回覆現在會按到達順序顯示，即使較慢的智慧體回覆稍後才出現，也不會插到前面",
          "當已儲存的會話失效時，智慧體可以自動重新開始，不會在後續每次提及時反覆失敗",
      ...
      },
      {
        ...
        fixes: [
          ...
          "智慧體 task 的發起人歷史在較早 task 記錄上也會更可靠",
          "滾動時置頂的任務評論邊緣顯示更乾淨",
          "新上傳的附件會使用穩定的私有下載連結，臨時上傳連結過期後圖片和檔案仍能正常顯示",
          "自動任務透過新建任務啟動後，如果對應的智慧體 task 失敗，會同步標記為失敗，不會一直卡在進行中",
      ...
      },
      {
        ...
        features: [
          ...
          "以 /note 開頭的評論現在可以記錄上下文，但不會喚醒已分配的智慧體，團隊可以留下協作備註而不觸發執行",
          "Antigravity 現在可以作為每個智慧體單獨選擇的模型",
          "命令列現在會用更容易理解的語言解釋常見請求失敗，並提示下一步該怎麼處理",
        ],
        improvements: [
          "任務頂部現在會顯示智慧體線上訊號，位置更緊湊，也更容易掃讀",
        ...
        fixes: [
          ...
          "守護程序現在會明確顯示自重啟失敗原因；從服務端結束終端 task 時會停止本地智慧體；倉庫維護時也會清理過期分支",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "飛書群聊裡提及智慧體時，會帶上附近的對話上下文，智慧體更容易理解團隊前面在討論什麼",
          "管理員可以直接在智慧體整合區域斷開飛書 Bot，不需要再去設定頁操作",
          "自託管工作區現在不需要額外配置定時任務，也能持續更新使用量資料",
          "命令列現在可以用外部 MCP 配置檔案建立和更新智慧體",
        ],
        improvements: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "支援 Lark 第三方整合，掃碼就能把 Multica 智慧體建立成一個 Lark Bot",
          "聊天現在支援可搜尋的智慧體選擇器和明確的上下文選擇器，更容易指定誰來回復、需要看哪些內容",
          "描述和評論現在支援勾選式待辦清單，任務裡的輕量計劃更好整理",
          "智慧體現在內建 Multica 技能，可以更穩定地遵循工作區工作流",
        ],
        improvements: [
      ...
      },
      {
        ...
        features: [
          ...
          "聊天現在支援 /skill command，用來選擇智慧體技能",
          "工作區現在可以顯示自定義 Logo",
          "可以給智慧體追加技能，不會覆蓋已有技能",
          "OpenCode 智慧體現在支援思考強度 variant",
        ],
        improvements: [
          "早期使用者如果沒有填寫入門來源問題，現在可以在之後補充，不需要重新走完整入門流程",
          "已停用的智慧體現在會在各處顯示為已歸檔，不再看起來像離線或仍在工作",
          "聊天曆史和任務執行記錄的懸浮操作更清晰，減少文字截斷和按鈕重疊",
          "專案裡的任務篩選現在會在列表、看板和時間線檢視中一致應用智慧體工作中篩選",
        ],
        fixes: [
          "無許可權使用者不能再透過間接的任務或評論路徑觸發私有小隊負責人",
          "專案進度統計和重新進入工作的智慧體狀態重新整理更可靠",
      ...
      },
      {
        ...
        features: [
          ...
          "智慧體列表可以按執行機器篩選，更快找到繫結到某臺裝置或本機執行服務的智慧體",
          "郵件傳送服務現在支援安全的 465 埠連線",
          "OpenCode 執行環境可以使用智慧體裡儲存的 MCP 設定",
          "OpenCode 智慧體現在會把模型 variant 顯示為思考強度控制，並把選擇結果傳給執行時",
        ],
        improvements: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "智慧體在任務評論區繼續工作時，會接著之前的會話繼續，不再新開會話，task 上下文可以保留下來",
          "Multica 現在支援韓語介面、官網和文件，包含完整韓語文件與本地化日期顯示",
          "任務頁面會在標題附近固定顯示正在工作的智慧體，多智慧體同時工作時也能更清楚地檢視",
          "智慧體讀取任務討論時可以先看到執行緒摘要、回覆數量和最近活躍時間，更快找到需要跟進的上下文",
          "OpenClaw 執行環境現在可以使用智慧體裡儲存的 MCP 設定，Claude Opus 4.8 也可用於模型選擇和用量估算",
        ],
        improvements: [
          "詳情頁統一了麵包屑導航，任務、專案、執行環境、技能、智慧體和小隊的返回路徑更清楚",
          "恢復中的智慧體 task 會少讀重複評論，更快回到觸發它的那條討論",
          "任務提及說明和命令列片段更容易閱讀，複製命令時不容易誤讀引數",
        ],
        fixes: [
          "更新、歸檔、恢復或從模板建立智慧體後，已繫結的技能仍會正確顯示",
          "單個智慧體完成自己負責的子任務後，父任務會繼續喚起它推進後續工作",
      ...
      },
      {
        ...
        features: [
          ...
          "智慧體詳情頁新增 MCP 配置，可用於 Hermes、Kimi 和 Kiro",
          "自託管管理員可以關閉自助建立工作區",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "專案現在可以在桌面端繫結本地工作目錄，智慧體 task 會直接在現有資料夾中執行，並在目錄被佔用時顯示等待狀態",
        ...
        fixes: [
          ...
          "無許可權訪問私有智慧體的使用者，不能再用普通評論觸發它們",
          "GitHub 設定、專案建立、看板排序和智慧體技能頁面清理了若干介面細節",
        ],
      },
      {
        version: "0.3.9",
        ...
        improvements: [
          ...
          "智慧體技能設定在釋出前收緊，產品裡不再顯示執行環境不支援的本機技能開關",
          "依賴檢查更嚴格，前端包會更早發現缺失依賴，減少打包和桌面端執行時的意外",
        ],
        fixes: [
          "GitHub PR 只有寫明關閉意圖時才會自動完成關聯任務，普通引用連結不會誤關任務",
          "父子任務的自動推進更穩：依賴未滿足時不會提前啟動後續任務，智慧體把待處理任務切到進行中時也會正確觸發負責人",
      ...
      },
      {
        ...
        features: [
          ...
          "專案資源選擇器新增倉庫搜尋，工作區倉庫設定也可以儲存描述，幫助智慧體理解每個程式碼庫",
        ...
        improvements: [
          ...
          "工作區倉庫描述會進入智慧體的任務上下文，讓分配的工作帶上更有用的專案背景",
      ...
      },
      {
        version: "0.3.6",
        date: "2026-05-22",
        title: "父子任務協作最佳化、實時智慧體工作狀態展示",
        changes: [],
        features: [
          "父任務會在子任務完成時自動收到更新，並通知對應負責人",
          "任務列表新增實時智慧體工作狀態，支援詳情檢視和工作中篩選",
      ...
      },
      {
        ...
        features: [
          ...
          "任務支援儲存面向智慧體的輕量狀態，自動化進度可以跟隨具體工作項，同時不打擾側邊欄閱讀",
          "較長的任務討論執行緒可以從最新回覆開始讀取，並保留原始討論上下文",
          "專案列表新增緊湊和舒適兩種檢視，小螢幕上也更容易瀏覽",
        ],
        improvements: [
          "命令列裡的工作區命令可以直接使用列表中的 slug 或短 ID",
          "智慧體模型選擇器移除了容易混淆的預設標籤",
          "自託管和智慧體文件修正了跳轉連結，並補全了配置說明",
          "保留路徑的保護更完整，避免特殊地址被誤用為工作區地址",
          "智慧體執行指引收緊了任務狀態寫入規則，只把後續執行確實需要的資訊留下",
        ],
        fixes: [
      ...
      },
      {
        version: "0.3.4",
        date: "2026-05-20",
        title: "自動任務專案歸屬、智慧體思考設定與更穩的桌面端",
        changes: [],
        features: [
          "自動任務現在可以透過小隊分配工作，並把建立的任務直接歸入指定專案",
          "智慧體設定新增 Claude 和 Codex 的思考強度控制，並可在詳情面板裡直接調整",
          "桌面端標籤頁可以固定，重要頁面會留在左側，開啟新內容時不打斷原頁面",
          "使用者資料可以補充請求者背景，讓程式碼智慧體在處理任務時更理解上下文",
  ...
  contactSales: {
    pageTitle: "聯絡商務",
    pageDescription:
      "瞭解如何在你的團隊中落地 Multica 的人類 + 智慧體協作工作流。",
    eyebrow: "聯絡商務",
    title: "先了解你的需求",
    subtitle: "在正式溝通之前，讓我們為你定製最合適的方案。",
    notice: {
      badge: "系統僅識別企業郵箱域名。",
      body: "來自個人郵箱（例如 @gmail.com、@outlook.com）的請求不會被處理。",
    },
    fields: {
      firstName: "名",
      lastName: "姓",
